...
def test_loads_legacy_regression_model_artifact_name(tmp_path, monkeypatch):
    """Inference remains compatible with artifacts produced before the sample_model rename."""
